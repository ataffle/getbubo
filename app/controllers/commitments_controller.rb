class CommitmentsController < ApplicationController
  ...
  def pre_closing
    ...
    @processed = Commitment.previous_month.where(status: "Paiement en attente", recurrence: "Mensuel").or(Commitment.previous_month.where(status: "Payé")).or(Commitment.current_month.where(postponed?: true, recurrence: "Ponctuel")).or(Commitment.current_month.where(status: "Facture en attente", recurrence: "Mensuel"))
  end
